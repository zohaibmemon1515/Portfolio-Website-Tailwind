...
const SkillBar: React.FC<SkillBarProps> = ({ skill, percentage, color }) => {
  return (
    <div className="flex items-center w-full mb-4">
      <h1 className="text-[#FFFFFF] font-semibold lg:w-40 md:w-32 w-28">{skill}</h1>

      <div className="flex-1 mx-4 bg-[#43366A] rounded-full py-1 h-4 relative overflow-hidden">
        <div
      ...
      <h1 className="text-[#FFFFFF] font-semibold w-12 text-right">{percentage}%</h1>
    </div>
  );
};
...
const Skills: React.FC = () => {
  return (
    <div className="bg-[#170550] h-auto flex flex-col justify-center items-center px-4 pb-20 font-sans">
      ...
      <div className="max-w-6xl w-full px-[2rem] lg:px-[6rem] md:px-[2rem]  lg:space-y-10 md:space-y-7 space-y-10 mt-5">
